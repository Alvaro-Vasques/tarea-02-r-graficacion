...
```{r}
ggplot(ca_covid19, aes(x=reorder(pais , -positivos), y=positivos)) + geom_col()+
  ggtitle("Casos positivos de covid19 por paises")+
  xlab("Pais")+
  ylab("Casos")+
...
```{r}
ggplot(ca_covid19, aes(x=reorder(pais , -recuperados), y=recuperados)) + geom_col()+
  ggtitle("Casos recuperados de covid19 por paises")+
  xlab("Pais")+
  ylab("Casos")+
...
```{r}
ggplot(ca_covid19, aes(x=reorder(pais , -activos), y=activos)) + geom_col()+
  ggtitle("Casos activos de covid19 por paises")+
  xlab("Pais")+
  ylab("Casos")+
...
```{r}
ggplot(ca_covid19, aes(x=reorder(pais , -fallecidos), y=fallecidos)) + geom_col()+
  ggtitle("Casos fabellecidos de covid19 por paises")+
  xlab("Pais")+
  ylab("Casos")+
...
```{r}
ggplot(ca_covid19, y=)+
  ggtitle("Casos de covid19 por paises")+
  xlab("Pais")+
  ylab("Casos")+
  geom_col(aes(pais ,positivos), fill="orange",  position = "dodge")+
  geom_col(aes(pais ,recuperados), fill="darkblue")+
  geom_col(aes(pais ,activos),fill="red")+
  geom_col(aes(pais ,recuperados), fill="purple")
```
